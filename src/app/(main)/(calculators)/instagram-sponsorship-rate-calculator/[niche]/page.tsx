...
export async function generateMetadata({ params }: NichePageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `/instagram-sponsorship-rate-calculator/${data.slug}`,
    },
    alternates: {
      canonical: `/instagram-sponsorship-rate-calculator/${data.slug}`,
    },
  };
}
    ...
    <>
      ...
      <CalculatorLayout
        ...
        breadcrumbs={[
          ...
          { name: 'Sponsorship Rate', path: '/instagram-sponsorship-rate-calculator' },
