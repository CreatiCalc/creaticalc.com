...
const TikTokSponsorshipCalculator = dynamic(
  () => import('@/features/calculators/tiktok-sponsorship/TikTokSponsorshipCalculator')
);
...
export const metadata: Metadata = {
  ...
  description:
    'Get your TikTok sponsorship price instantly (no sign-up). Trusted by 50K+ creators to calculate fair rates for videos, Spark Ads & Lives.',
  openGraph: {
    title: 'TikTok Sponsorship Price Calculator [Free]: Get Your Rate Instantly',
    description:
      'Get your TikTok sponsorship price instantly (no sign-up). Trusted by 50K+ creators to calculate fair rates for videos, Spark Ads & Lives.',
      ...
      >
        ...
        <section className="mt-12">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {getSponsorshipNichePages('tiktok').map((niche) => (
              <Link
                key={niche.slug}
                href={`/tiktok-sponsorship-rate-calculator/${niche.slug}`}
