...
const CONFIG: SponsorshipNicheConfig = {
  ...
  relatedLinks: [
    { href: '/youtube-sponsorship-rate-calculator', label: 'YouTube Sponsorship Rate Calculator', description: 'calculate rates across all niches' },
    { href: '/youtube-money-calculator', label: 'YouTube Money Calculator', description: 'estimate your YouTube ad revenue' },
