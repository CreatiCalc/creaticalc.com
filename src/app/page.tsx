...
const calculators = [
  ...
  },
  {
    ...
    description:
      "Calculate your Instagram engagement rate and see how you compare.",
    href: "/instagram-engagement-rate-calculator",
  },
  {
    title: "TikTok Engagement Rate",
    description:
      "Measure your TikTok engagement rate with views, likes, and shares.",
    ...
    <div className="mx-auto max-w-6xl px-4 py-16">
      <section className="mb-16 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-muted">
          Estimate your YouTube earnings, calculate engagement rates on
          Instagram and TikTok, and project your subscriber growth — all for
          free.
        </p>
      </section>
