  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Estimate how much YouTube Shorts pay per 1,000 views
        </div>
        <div
          style={{
            display: 'flex',
        ...
        >
          ...
          >
            <div style={{ fontSize: 16, opacity: 0.8 }}>Per 1M Views</div>
            <div style={{ fontSize: 24, fontWeight: 700 }}>$20 — $80</div>
          </div>
          <div
            style={{
              display: 'flex',
          ...
          >
            ...
            <div style={{ fontSize: 24, fontWeight: 700, color: '#0f172a' }}>45%</div>
          </div>
        </div>
      </div>
    </div>,
